...
class ClientViewModel(var navController: NavController,
    ...
    fun saveClient(
        filePath: Uri, fullNames: String, YourJob: String, gender: String, age:String,
        bio: String){
        ...
        storageReference.putFile(filePath).addOnCompleteListener{
            if (it.isSuccessful){
                storageReference.downloadUrl.addOnSuccessListener{
                    ...
                    var houseData = Client(imageUrl,fullNames,YourJob,gender,age,bio,id)
    ...
    fun updateClient(
        ...
        if (filePath != Uri.EMPTY) {
            ...
            imageRef.putFile(filePath)
                .addOnSuccessListener {
                    imageRef.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        val updatedClient = Client(imageUrl, fullNames, YourJob, gender, age, bio, id)
            ...
            val updatedClient = Client("", fullNames, YourJob, gender, age, bio, id)
            databaseReference.setValue(updatedClient)
                .addOnCompleteListener { task ->
                    if (task.isSuccessful) {
                        Toast.makeText(context, "Update successful", Toast.LENGTH_SHORT).show()
